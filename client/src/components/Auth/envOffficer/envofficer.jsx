...
const EnvOfficeRegister = () => {
    ...
    const handleSubmit = async (e) => {
        e.preventDefault();
        try {
            const response = await axios.post(url + '/api/auth/register', { ...formData, role: "environmental_officer" });
    ...
    return (
        <Container className="d-flex justify-content-center align-items-center" style={{ height: '100vh' }}>
            <Card style={{ width: '350px', padding: '30px', borderRadius: '15px', boxShadow: '0 5px 15px rgba(0, 0, 0, 0.3)' }}>
...
export default EnvOfficeRegister;
